...
-- 1. Survey ID=1 (ITエンジニア意識調査) by user
INSERT INTO responses (id, survey_id, username, status, created_at, updated_at) VALUES (1, 1, 'user', 'VALID', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Q1: 普通(3)
INSERT INTO response_details (response_id, question_id, answer_pattern_item_id) VALUES (1, 1, 3);
-- Q2: はい(6)
INSERT INTO response_details (response_id, question_id, answer_pattern_item_id) VALUES (1, 2, 6);

-- 2. Survey ID=1 (ITエンジニア意識調査) by admin
...
-- 3. Survey ID=2 (サービス満足度調査) by user
INSERT INTO responses (id, survey_id, username, status, created_at, updated_at) VALUES (3, 2, 'user', 'VALID', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Q3: はい(6)
INSERT INTO response_details (response_id, question_id, answer_pattern_item_id) VALUES (3, 3, 6);
-- Q4: 4(9)
INSERT INTO response_details (response_id, question_id, answer_pattern_item_id) VALUES (3, 4, 9);
-- Q5: 自由記述
INSERT INTO response_details (response_id, question_id, answer_text) VALUES (3, 5, '特になし');

-- 4. Survey ID=4 (社内イベント感想) by user
INSERT INTO responses (id, survey_id, username, status, created_at, updated_at) VALUES (4, 4, 'user', 'VALID', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Q6: 自由記述
INSERT INTO response_details (response_id, question_id, answer_text) VALUES (4, 6, 'とても楽しかったです。');

-- 5. Survey ID=5 (新入社員研修の感想) by user
INSERT INTO responses (id, survey_id, username, status, created_at, updated_at) VALUES (5, 5, 'user', 'VALID', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Q7: 5(8)
INSERT INTO response_details (response_id, question_id, answer_pattern_item_id) VALUES (5, 7, 8);
-- Q8: 普通(3)
INSERT INTO response_details (response_id, question_id, answer_pattern_item_id) VALUES (5, 8, 3);
-- Q9: 自由記述
...
-- Q11: 3(10)
INSERT INTO response_details (response_id, question_id, answer_pattern_item_id) VALUES (6, 11, 10);

-- 7. Survey ID=7 (春のお花見イベント参加確認) by user
INSERT INTO responses (id, survey_id, username, status, created_at, updated_at) VALUES (7, 7, 'user', 'VALID', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Q12: はい(6)
...
-- 8. Survey ID=7 (春のお花見イベント参加確認) by admin
INSERT INTO responses (id, survey_id, username, status, created_at, updated_at) VALUES (8, 7, 'admin', 'VALID', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Q12: いいえ(7)
INSERT INTO response_details (response_id, question_id, answer_pattern_item_id) VALUES (8, 12, 7);
-- Q13: 自由記述 (NULL)
INSERT INTO response_details (response_id, question_id, answer_text) VALUES (8, 13, NULL);

-- 9. Survey ID=8 (開発ツールと技術関心に関する調査) by user
